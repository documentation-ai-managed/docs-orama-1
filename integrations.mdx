---
title: Bank and Tool Integrations
description: Connect Orama to your banking providers and external services for real-time data synchronization and enhanced workflow automation.
---
...
<Columns cols={3}>
  <Card title="Banks" icon="database" href="#banks">
    BBVA, Santander, CaixaBank, Sabadell
  </Card>
  <Card title="Accounting Tools" icon="file-text" href="#tools">
    Holded, A3, Contasol
  </Card>
  <Card title="ERP Systems" icon="settings" href="#erp">
...
<Steps>
  <Step title="Select Provider" icon="search">
    In your Orama dashboard, navigate to <strong>Integrations</strong> > <strong>Banks</strong>. Choose your provider from the list.
  </Step>
  <Step title="Authorize Access" icon="shield">
    Click <strong>Connect</strong>. You'll be redirected to your bank's OAuth page. Grant read-only access to transactions and balances.
  </Step>
  <Step title="Configure Sync" icon="settings">
    Set sync interval (real-time, hourly, daily). Test the connection with a manual sync.
  </Step>
  <Step title="Verify Data" icon="check-circle">
    Review imported transactions in the <strong>Transactions</strong> tab. Resolve any mapping issues.
  </Step>
</Steps>
...
<Tabs>
  <Tab title="Bank (OAuth)" icon="banknote">
    ...
    <Image
      src="https://example.com/bank-oauth.png"
      alt="Bank OAuth authorization flow"
      width="800"
      height="400"
    />
  </Tab>
...
<ExpandableGroup>
  ...
  <Expandable title="Data Mapping Errors">
    Use custom rules in <strong>Import Rules</strong> to map categories and accounts.
  </Expandable>
</ExpandableGroup>
